    ...
    <div className="footer footer-bottom">
      <div className="row">
        ...
        <div className="footer-icons">
          <a href="https://github.com/MarloweCrosland" target="_blank"><img className="icon github" src={'https://w7.pngwing.com/pngs/857/611/png-transparent-github-git-hub-logo-icon-thumbnail.png'} alt="github logo" /></a>
