  ...
  return (
    ...
    <div className="row">
        <div className='gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe'>
            <a className="links" href='https://mwjones2186.github.io/camp-firecast/'>
                <h6 id="heading">Camp Firecast</h6>
                <img src={galleryImg1} className='img-thumbnail' alt='Camp Firecast thumbnail' />
            </a>
        ...
        <div className='gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe'>
            <a className="links" href='https://codetrip-33a81.web.app'>
                ...
                <img src={galleryImg2} className='img-thumbnail' alt='Genu thumbnail' />
            </a>
        </div>
